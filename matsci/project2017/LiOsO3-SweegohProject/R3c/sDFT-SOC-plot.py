...
#R_3c_PV = pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-PV.dat', header=None, delim_whitespace=True)
#R_3c_toten=pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-toten.dat', header=None, delim_whitespace=True)
R_3c_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-enthalpy.dat', header=None, delim_whitespace=True)
#R3c_PV=pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-PV.dat', header=None, delim_whitespace=True)
#R3c_toten=pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-toten.dat', header=None, delim_whitespace=True)
R3c_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-enthalpy.dat', header=None, delim_whitespace=True)
#Imma_PV=pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-PV.dat', header=None, delim_whitespace=True)
#Imma_toten=pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-toten.dat', header=None, delim_whitespace=True)
Imma_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-enthalpy.dat', header=None, delim_whitespace=True)
#Pbnm_PV=pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-PV.dat', header=None, delim_whitespace=True)
#Pbnm_toten=pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-toten.dat', header=None, delim_whitespace=True)
#Pbnm_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-enthalpy.dat', header=None, delim_whitespace=True)
#Pnma_PV=pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-PV.dat', header=None, delim_whitespace=True)
#Pnma_toten=pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-toten.dat', header=None, delim_whitespace=True)
Pnma_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-enthalpy.dat', header=None, delim_whitespace=True)
