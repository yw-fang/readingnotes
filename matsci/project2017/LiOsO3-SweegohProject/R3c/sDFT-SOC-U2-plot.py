...
#R_3c_PV = pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-U2-PV.dat', header=None, delim_whitespace=True)
#R_3c_toten=pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-U2-toten.dat', header=None, delim_whitespace=True)
R_3c_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/R-3c-AFM-SOC-U2-enthalpy.dat', header=None, delim_whitespace=True)
#R3c_PV=pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-U2-PV.dat', header=None, delim_whitespace=True)
#R3c_toten=pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-U2-toten.dat', header=None, delim_whitespace=True)
R3c_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/R3c-AFM-SOC-U2-enthalpy.dat', header=None, delim_whitespace=True)
#Imma_PV=pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-U2-PV.dat', header=None, delim_whitespace=True)
#Imma_toten=pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-U2-toten.dat', header=None, delim_whitespace=True)
Imma_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Imma-AFM-SOC-U2-enthalpy.dat', header=None, delim_whitespace=True)
#Pbnm_PV=pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-U2-PV.dat', header=None, delim_whitespace=True)
#Pbnm_toten=pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-U2-toten.dat', header=None, delim_whitespace=True)
#Pbnm_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Pbnm-AFM-SOC-U2-enthalpy.dat', header=None, delim_whitespace=True)
#Pnma_PV=pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-U2-PV.dat', header=None, delim_whitespace=True)
#Pnma_toten=pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-U2-toten.dat', header=None, delim_whitespace=True)
Pnma_enthalpy = pd.read_csv('./sDFT-SOC-U-verification/Pnma-AFM-SOC-U2-enthalpy.dat', header=None, delim_whitespace=True)
...
pp1 = PdfPages('./enthalpy-sDFT-SOC-U2.pdf')
pp1.savefig(fig1)
pp1.close()
