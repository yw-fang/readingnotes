...
ph_settings = ParameterData(dict={'supercell': [[2, 0, 0],
                                  ...
                                  'code': {'fc2': 'phonopy@bridges',  # this uses phonopy.phonopy
                                           'fc3': 'phono3py@bridges'},  # this uses phonopy.phono3py
...
if code_to_use == 'VASP':
    ...
    settings_dict = {'code': {'optimize': 'vasp544std@bridges',
                              'forces': 'vasp544std@bridges',
                              'born_charges': 'vasp544std@bridges'},
...
if not run_by_deamon:
    ...
    future = submit(ThermalPhono3py,
                    ...
                    use_nac=Bool(False),
                    chunks=Int(60),  # set the number of maximum simultaneous calculations
                    initial_cutoff=Float(6.0),  # Initial cutoff in Angstrom
                    step=Float(1.0),  # Step cutoff in Angstrom
